...
/// Redeyed Lab (https://redeyed.com/lab). The site key is **public** and safe
/// to ship inside the app. Your **secret API key is never used in the app** —
/// verification happens on your own server (see the README).
